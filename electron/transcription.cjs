...
async function transcribeAudio({key,routerKey,audio,mimeType='audio/webm',language='auto',signal}, fetcher=globalThis.fetch) {
...
module.exports={transcribeAudio,languages};
