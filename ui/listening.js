...
window.dexterity.onNative(event=>{
 ...
 if(event.type==='voice-transcribing') { document.getElementById('title').textContent='Writing what you said…';document.getElementById('voice-provider').textContent=event.engine+' voice · microphone off';document.getElementById('transcript').textContent='Transcribing your recording. Review the text, then press Run to start.';document.getElementById('done').disabled=true;document.getElementById('voice-countdown').textContent='Microphone off'; }
